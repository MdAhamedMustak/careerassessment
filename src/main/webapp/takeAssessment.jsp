...
<body>
    <div class="container py-5">
        ...
        <!-- Timer Display -->
        <div id="timer" class="text-center mb-4 timer">
            Time Remaining: <span id="timeRemaining">10:00</span> minutes
        </div>
    ...
    <script>
        ...
        function startTimer() {
            timerInterval = setInterval(function() {
                ...
                document.getElementById("timeRemaining").textContent = `${minutes}:${seconds < 10 ? '0' : ''}${seconds}`; // Updated to display seconds properly
                if (timeRemaining <= 0) {
