    ...
    <div class="content">
        ...
        <div class="team-section">
            ...
            <div class="team-cards">
                <!-- Team Member 1 -->
                <div class="team-card">
                    <img src="boku.jpg" alt="Team Member 1">
                    <h3>Sambangi Vivek</h3>
                    <p>Project Lead - Responsible for overseeing the entire project and ensuring timely delivery.</p>
                </div>
                <!-- Team Member 2 -->
                <div class="team-card">
                    <img src="my.jpg" alt="Team Member 2">
                    <h3>Md Ahamed Mustak</h3>
                    <p>Frontend Developer - Designs and develops user-friendly interfaces using JSP integrated with HTML, CSS, and JavaScript, ensuring a responsive and dynamic user experience.Backend Developer - Manages the server-side logic and database integration using Spring Boot and MySQL to create robust and scalable backend systems</p>
                </div>
